...
namespace Arcana
{
    ...
    public class DatabaseLink
    {
        ...
        {
            //Hard coded. I didn't have time to
            //get these values read in from a text file.
            server = "127.0.0.1";
            database = "Arcana";
            uid = "ArcanaGame";
            password = "password";
        ...
        public List<string>[] Select(int playerNumber)
        {
            ...
            //The length of list is the columns
            //The length of each individual element
            //(assumed to all be equal) is the number
            //of rows.
